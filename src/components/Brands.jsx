...
export const Brands = () => (
  <section className="mb-16 w-full bg-customDarkBg1 py-12 sm:py-14">
    <motion.div
      initial={{ opacity: 0 }}
        ...
        <div className="-mx-4 flex flex-col items-center justify-center text-center lg:flex-row lg:text-left">
          <div className="mb-12 w-full px-4 lg:mb-0 lg:w-1/2">
            <div className="flex flex-col">
              <h2 className="mb-2 text-3xl font-bold tracking-normal text-white sm:text-4xl 2xl:text-5xl">
                Empresas que
              </h2>
              <h2 className=" text-3xl  font-bold tracking-normal text-customSecondary sm:text-4xl 2xl:text-5xl">
                confiam na gente
              </h2>
            </div>
          </div>
